...
- [Performance claims policy](performance-claims-policy.md) — publish certified figures and raw measurements only; never extrapolated numbers (e.g. pull-force → implied MPH).
