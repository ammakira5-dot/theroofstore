...
- **CTA wording rule (owner-requested July 31, 2026, from same audit — still needs its own task queued):** "Get a Free Estimate" is ambiguous. Where the offer is installation, wording must include "contracting"/"contractor" language (e.g. "Free Contracting Estimate"); where the audience is product buyers (shop, factory buy-direct card, city buy-direct lane), offer a clearly distinct "Get a Product Quote" path. Wording only — no layout/nav changes. Any task touching CTAs should apply this rule.
