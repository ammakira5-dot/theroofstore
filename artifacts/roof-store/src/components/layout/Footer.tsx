      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-primary-foreground/80">
                ...
                <a href="mailto:theroofstore@gmail.com" className="hover:text-accent transition-colors">theroofstore@gmail.com</a>
              </li>
              <li className="flex items-start gap-3 text-primary-foreground/80">
        ...
        <div className="border-t border-primary-foreground/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/60">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/the-original-roof-store-florida" className="hover:text-white transition-colors">Trademark Notice</Link>
          </div>
        </div>
      </div>
    </footer>
