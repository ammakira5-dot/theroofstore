...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "There are also three Florida-specific factors that don't apply the same way in most other states. First: the Dade County Certified TAS-106 Uplift Test — the only hurricane-rated test result any liquid roof coating has passed — reflects the full system as professionally installed, not the materials alone. A DIY application of our Roof Shield materials would not carry that test-verified result, because it is tied to licensed installation. Second: an Additional Roof Life Certification, which carries legal weight with Citizens Insurance and private carriers under SB 2-D (Fla. 2022) and can prevent a forced roof replacement, must be signed by a licensed contractor. DIY-applied systems cannot receive this certification. Third: Florida's contractor licensing laws generally require a licensed roofing contractor for most commercial installations, and while residential owner-occupant DIY isn't prohibited, unlicensed work can create disclosure complications at the point of sale or refinance.",
      "The equipment cost alone narrows the gap significantly. A commercial-grade pressure washer, professional nozzle set, appropriate mildewcide, commercial airless sprayer or heavy-duty roller system, fall-protection equipment, and all repair materials often add up to $2,000–$3,500 before you purchase any coating. That's before accounting for the value of a warranty, the passed Dade County Certified TAS-106 Uplift Test result, or the insurance certification. Our recommendation: for a small flat-roof section under 500 sq ft on a single-story home, a competent homeowner who does the prep correctly can get reasonable results with a quality coating. For a full tile roof on a two-story home in hurricane country — especially one where Citizens Insurance is a factor — the professional route delivers measurably better outcomes at a total cost that is closer to DIY than most homeowners expect. Call 954-210-9614 for a free written estimate and you'll have the real numbers to compare.",
    ],
    metaDescription:
      "DIY roof coating in Florida: the honest guide from 30 years in the field. Surface prep failures, Dade County Certified TAS-106 Uplift Test requirements, insurance certification, and true cost comparison. Call 954-210-9614.",
    keywords: ["DIY roof coating Florida", "professional roof coating vs DIY", "Dade County Certified TAS-106 Uplift Test", "roof coating surface preparation", "Citizens Insurance roof certification", "South Florida roof coating contractor"],
  },
  {
    slug: "how-to-seal-a-concrete-tile-roof-south-florida",
    title: "How to Seal a Concrete Tile Roof in South Florida: The Complete Step-by-Step Guide",
    url: `${BASE}/blog/how-to-seal-a-concrete-tile-roof-south-florida/`,
    image: "/images/projects/flat-cement-after.png",
    imageAlt: "Concrete tile roof in Broward County, Florida after full sealing with elastomeric waterproofing system",
    date: "July 2026",
    dateISO: "2026-07-28",
    tag: "How-To Guide",
    excerpt:
      "Concrete tile is the most common roof in South Florida — and the most misunderstood. The tiles themselves aren't waterproof; the system underneath is. Here is the complete professional process for sealing a concrete tile roof, from inspection and pressure cleaning through primer, coating layers, and final cure — the same process our crews follow on every job.",
    body: [
      "Start with what most homeowners don't know: concrete tiles are porous. A bare concrete tile absorbs water like a sponge — the actual waterproofing on a tile roof is the underlayment beneath the tiles, which in South Florida is typically 15–30 years old and degrading in the heat. Sealing the tile field with an elastomeric coating system does two things at once: it stops the tiles from absorbing water (which adds enormous weight during storms and accelerates cracking), and it bonds the tile field into a single monolithic surface that resists wind uplift. The first step of any sealing project is a full inspection — walk the roof, flag every cracked or slipped tile, check ridge caps, valleys, and penetrations. Every defect gets repaired before any coating goes down. Coating over a cracked tile or a loose ridge cap just seals the problem in.",
      "Step two is the step that determines whether the job lasts 3 years or 20: cleaning and preparation. The roof needs a commercial pressure wash at 2,500+ PSI with a mildewcide treatment to kill algae and mold spores down in the pores of the concrete — not just blast off the visible black streaks. In South Florida's humidity, any algae left alive under the coating will regrow and delaminate the coating from below. After the wash, the roof must dry fully, then all repairs are made: cracked tiles replaced or repaired with flexible mastic, ridge caps re-seated and sealed, valleys and flashings checked and re-sealed. Only then does primer go down. On concrete tile, a penetrating primer-sealer soaks into the porous surface and gives the coating layers something to grip — skipping primer is the second most common cause of coating failure after bad prep.",
      "Step three: the coating layers themselves. A professional system on concrete tile in South Florida is a multi-coat application — a base coat that fills the tile surface and seals the gaps between overlapping tiles, followed by one or more finish coats that provide UV resistance, color, and the final waterproof membrane. Each coat has to be applied at the correct thickness (measured in mils, not by eye) and given proper cure time between coats — in summer humidity that can mean waiting a full day between coats, and never coating when afternoon thunderstorms are in the forecast. The gaps between tiles matter more than the tile faces: when the spaces between overlapping tiles are bridged with elastomeric material, the entire roof becomes one continuous structure — this is the principle behind our Roof Shield system, the only liquid roof coating to pass the Dade County Certified TAS-106 Uplift Test for wind resistance.",
      "Timing and maintenance: the best months to seal a tile roof in South Florida are November through May — the dry season — when humidity is lower and afternoon storms are rare. A properly sealed concrete tile roof should get a 30-minute visual inspection once a year: look for thin spots, hairline separation at penetrations, and any new cracked tiles from foot traffic or debris. Caught early, these are inexpensive spot repairs. If you want the job done professionally — with a written warranty, a system that passed the Dade County Certified TAS-106 Uplift Test, and documentation that supports an Additional Roof Life Certification for your insurance — call The Roof Store at 954-210-9614 for a free inspection and written estimate. We manufacture the coatings in our Davie, FL factory and our own licensed crews install them, so you get factory-direct pricing either way: full installation, or product only if you want to do it yourself.",
    ],
    metaDescription:
      "Complete professional guide to sealing a concrete tile roof in South Florida: inspection, pressure cleaning, primer, multi-coat elastomeric application, cure times, and maintenance. From the factory that makes the coating.",
    keywords: ["how to seal a concrete tile roof", "concrete tile roof sealing South Florida", "tile roof waterproofing Florida", "elastomeric coating concrete tile", "tile roof primer sealer", "TAS-106 roof coating"],
  },
];
