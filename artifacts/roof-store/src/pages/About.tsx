  ...
  const schema = [
    {
      ...
      mainEntity: {
        ...
        description: "The Roof Store is a Florida-licensed roofing contractor and the exclusive seller of Roof Protect's proprietary roof coating systems — Fungal Shield, Smart Shield, and Roof Shield — manufactured in Davie, FL. We sell these products and install them with our own licensed crew.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              ...
              <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
                Welcome to Theroofstore.net. For nearly 30 years, The Roof Store has been Florida's trusted source for Roof Protect's proprietary roof coating systems — <strong className="text-foreground">Fungal Shield, Smart Shield, and Roof Shield</strong> — formulated and produced in Davie, Florida. We're a licensed roofing contractor and the exclusive seller of these systems, and we install them with our own licensed crew.
              </p>
              <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
