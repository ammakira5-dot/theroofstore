...
const milestones = [
  ...
  { year: "2000", event: "We open our first online store — \"Anthony Enterprises\" — selling Thermocoat roof coating with a working shopping cart under the same \"Don't Reroof — Weatherproof at ½ the Cost\" banner, years before most contractors had a website at all." },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                desc: "The Roof Store's systems restore and weatherproof your existing roof — installed, including labor and materials — for typically 60–70% less than a full tile roof replacement.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
