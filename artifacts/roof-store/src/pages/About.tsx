...
export default function About() {
  const schema = [
    ...
    },
    {
      ...
      offers: { "@type": "Offer", priceCurrency: "USD", price: "190", availability: "https://schema.org/InStock" },
    },
    {
      "@context": "https://schema.org",
      "@type": "Product",
      ...
      brand: { "@type": "Brand", name: "RoofProtect Products" },
      offers: { "@type": "Offer", priceCurrency: "USD", price: "285", availability: "https://schema.org/InStock" },
    },
    {
      "@context": "https://schema.org",
      "@type": "Product",
      ...
      brand: { "@type": "Brand", name: "RoofProtect Products" },
      offers: { "@type": "Offer", priceCurrency: "USD", price: "325", availability: "https://schema.org/InStock" },
    },
    {
      "@context": "https://schema.org",
      "@type": "VideoObject",
