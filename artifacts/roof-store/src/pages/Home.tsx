...
const BUSINESS_CORE = {
  ...
  description: "South Florida's original elastomeric roof coating company, serving homeowners and businesses since 1994. FungalShield, SmartShield & RoofShield systems weatherproof tile, flat, and metal roofs at up to 60–70% less than the cost of replacement.",
  ...
  return (
    <div className="w-full">
      <SEO
        ...
        description="Florida's original elastomeric roof coating system. Save up to 60–70% vs. replacement. A+ BBB rated since 1994. Serving Broward, Miami-Dade & Palm Beach. Free consultation."
        canonical="/"
          ...
          <div className="bg-primary rounded-2xl p-10 flex flex-col md:flex-row items-center gap-8 text-white">
            <div className="flex-1">
              ...
              <h2 className="text-3xl font-serif font-bold mb-3 leading-tight">
                Weatherproof your existing roof for up to 60–70% less than the cost of replacement.
              </h2>
      ...
      <section className="py-24 bg-muted">
        <div className="container px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg mb-6">We provide comprehensive <Link href="/roof-services" className="text-accent font-semibold hover:underline">roof coating and restoration services</Link> that save you money while delivering superior protection across South Florida.</p>
