...
const schema = {
  ...
  provider: {
    ...
    member: [
      ...
      { "@type": "Organization", name: "Storm Shield Roof Coating Systems", telephone: "+15613284770", areaServed: ["Port St. Lucie FL", "Treasure Coast FL"], address: { "@type": "PostalAddress", streetAddress: "2049 SW Cranberry St", addressLocality: "Port St. Lucie", addressRegion: "FL", postalCode: "34953", addressCountry: "US" } },
...
const partners = [
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: "Patricia Wilson", text: "I live in an HOA and had some missing and broken tiles replaced and needed to match the color, the roof paint looks great now and no more notices, highly recommend them." },
  ...
  },
  {
    ...
    badge: "South Florida",
    reviewsTitle: "Customer Reviews — Roof Restorations and Waterproofing Inc · ⭐ 5.0 · 9 Google Reviews",
    linkPaused: false,
    gmbOnly: false,
    reviews: [
      ...
      { author: "Elizabeth Mendez", text: "Very happy with the product! Saves us money in the bank and provides protection for lasting roof system. Company stands by its warranty." },
      { author: "Michael Aven", text: "very satisfied with we hired them to do, if I could I would give them a 10" },
    ],
  },
];
