...
const pricingFaqs = [
  ...
  },
  {
    ...
    a: "Yes — two ways. First, our RoofShield (RP3) system passed the Dade County Certified TAS-106 Uplift Test, which Florida SB 2-D requires insurers to discount. Second, Florida law gives every homeowner the right to request an independent Useful Life Exam — an inspection by a licensed contractor or engineer. It is that inspector's report, not any contractor or product, that the insurance company is legally required to recognize. The most effective thing you can do is put your roof in the best possible condition before that exam: professionally cleaned, repaired, and coated. That is exactly what we do.",
  },
  {
