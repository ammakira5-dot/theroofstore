...
const products = [
  ...
  },
  {
    ...
    coverageSqFt: 90,
    summary:
      "The result of 40 years of innovation — engineered with BASF chemistry to deliver maximum solar reflectance in darker tile colors. FP&L has independently confirmed SmartShield saves on cooling costs. Waterproof, mildew-proof, and stronger than your current tile surface.",
    highlights: [
      "FP&L (Florida Power & Light) confirmed saves on cooling costs",
      "Cool Pigment Technology — 23% more reflective than prior formula",
      "Engineered with BASF chemistry for reflectance in dark colors (charcoal, dark brown)",
      "Waterproofs tiles — protects against wind-driven rain",
      "Guaranteed mildew proof — adds surface durability and strength",
      "Non-seamless finish — looks just like new when complete",
    ],
    specs: [
      { label: "Product Code", value: "RP2 — SmartShield" },
      { label: "Coverage Rate", value: "~90 sq ft per gallon" },
      { label: "Reflectivity", value: "Cool Pigment Technology — 23% more reflective" },
      { label: "Energy Endorsement", value: "FP&L confirmed cooling cost savings" },
      { label: "Waterproofing", value: "Wind-driven rain resistant" },
      { label: "Mildew Resistance", value: "Guaranteed" },
      { label: "Manufactured", value: "Davie, FL — Storm Shield Paint Systems Inc." },
    ],
    bestFor: "Tile roofs (any color) where reducing cooling costs and FP&L energy savings are the goal.",
    extra: "BASF — the world's largest chemical producer — re-engineered our base resins and added its proprietary chemistry in 2018. The result passed a full cycle of tensile tests, flexural tests, DSC, TGA and viscosity testing. SmartShield's formulation is recognised worldwide as one of the most innovative reflective coatings of its kind.",
  },
  {
    code: "RP3",
    icon: ShieldCheck,
