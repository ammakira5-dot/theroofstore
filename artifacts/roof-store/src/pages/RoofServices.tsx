        ...
        <div className="container px-4 max-w-5xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-background rounded-xl p-8 border shadow-sm">
              ...
              <p className="text-muted-foreground leading-relaxed">Faded, chalky, or discolored roof tiles impact curb appeal and resale value. Our tile roof painting service uses professional-grade elastomeric and acrylic roof coatings in 3,000+ colors — built on our <Link href="/products/smartshield" className="text-accent font-semibold hover:underline">Smart Shield color coating system</Link> — to restore your tile's appearance or give it an entirely new look. All tile roof painting is done after professional pressure cleaning to ensure proper adhesion and a lasting finish.</p>
            </div>
            <div className="bg-background rounded-xl p-8 border shadow-sm">
              <h3 className="text-xl font-serif font-bold text-primary mb-3">Tile Roof Waterproofing</h3>
              <p className="text-muted-foreground leading-relaxed">In traditional tile roof design, water is expected to pass between tile gaps onto an underlayment paper below — a system that works only as long as that paper stays intact. Years of roof movement cause the paper to tear, letting water infiltrate the deck and leading to leaks, rot, and costly structural damage. Our <Link href="/products/smartshield" className="text-accent font-semibold hover:underline">Smart Shield system</Link> seals and waterproofs the tile surface itself with a durable, flexible coating. For roofs where the underlayment paper is aging or failing, our <Link href="/products/roofshield" className="text-accent font-semibold hover:underline">Roof Shield system</Link> retrofits the entire tile field into one monolithic, gap-filled surface — so water is never able to reach the paper at all — and carries the world's only TAS-106 Dade County Uplift rated coating. Clients have the option to add Smart Shield as a top coat over Roof Shield for maximum reflectivity and cooling on a dark color choice, combining both systems in one roof.</p>
            </div>
            <div className="bg-background rounded-xl p-8 border shadow-sm">
            ...
            <div className="bg-background rounded-xl p-8 border shadow-sm">
              ...
              <p className="text-muted-foreground leading-relaxed">Our <Link href="/products/smartshield" className="text-accent font-semibold hover:underline">Smart Shield reflective roof coating</Link> uses BASF Cool Pigment Technology to increase Total Solar Reflectance by 32% — even at the darkest black. This acrylic cool roof coating lowers attic temperatures and cooling costs while giving you 3,000+ tintable color choices, independently confirmed by Florida Power &amp; Light.</p>
            </div>
          </div>
        </div>
      </section>
