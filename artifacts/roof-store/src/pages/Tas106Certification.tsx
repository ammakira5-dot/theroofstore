    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "In most structurally sound tile roofs, yes. A tile lift-and-reset is re-roofing by another name — tiles off, new material underneath, tiles back on — a partial re-roof marketed as a repair, and it frequently causes new cracked tiles and new leaks. The Roof Shield (RP3) system instead flows liquid rubber into every gap between the tiles; when completed it is a seamless coating system — one continuous waterproof membrane above the tiles — so the roof no longer relies on the aged underlayment as its only water barrier. Understand what this retrofit really does: on a conventional roof, the tiles are there for architectural character and looks, with some overlapping protection for the paper layer underneath them — it is that paper, not the tiles, doing the real waterproofing. The Roof Shield monolithic system interlocks those tiles into a solid cement-and-clay top — one continuous shell — so wind and water shed across the surface with no spaces between the tiles for either to exploit. And the roof still looks nearly the same as it did before the system was applied: same Spanish tile character from the street, fundamentally different roof underneath. Cracked tiles and defects are repaired before coating. The one exception — discovered while undertaking our full onsite Manufacturer's Inspection Report (Roof Shield (RP3) requires this comprehensive, detailed report; other services receive an onsite evaluation, not the full report): any rotten or soft wood underneath the tile must be repaired first (tiles in that localized area are lifted, the bad piece of wood is removed and dried back in with traditional materials), and then the coating system proceeds over the sound roof. Per the inspection report, any insulation or wood that may be soft or wet must be repaired prior to the application of roof coatings. RP3 is far superior to any traditional roof material application, including synthetic underlayments.",
        },
      },
      {
        "@type": "Question",
...
const faqs = [
  {
    ...
    a: "In most structurally sound tile roofs, yes. A 'lift-and-reset' is re-roofing by another name — tiles off, new material underneath, tiles back on. It's a partial re-roof marketed as a repair, and it frequently causes new cracked tiles and new leaks unless you're committed to a full tile replacement. Don't re-roof when you don't have to. The Roof Shield (RP3) system takes a different path: our liquid rubber flows into and fills every gap between the tiles, and when completed it is a seamless coating system — one continuous waterproof membrane above the tiles — so the roof no longer relies on the aged underlayment as its only water barrier. Understand what this retrofit really does: on a conventional roof, the tiles are there for architectural character and looks, with some overlapping protection for the paper layer underneath them — it is that paper, not the tiles, doing the real waterproofing. The Roof Shield monolithic system interlocks those tiles into a solid cement-and-clay top — one continuous shell — so wind and water shed across the surface with no spaces between the tiles for either to exploit. And the roof still looks nearly the same as it did before the system was applied: same Spanish tile character from the street, fundamentally different roof underneath. Every project begins with inspection and repair of cracked tiles and defects before coating. The one exception — discovered while undertaking our full onsite Manufacturer's Inspection Report (Roof Shield (RP3) requires this comprehensive, detailed report; other services receive an onsite evaluation, not the full report): any rotten or soft wood underneath the tile must be repaired first (tiles in that localized area are lifted, the bad piece of wood is removed and dried back in with traditional materials), and then the coating system proceeds over the sound roof. Per the inspection report, any insulation or wood that may be soft or wet must be repaired prior to the application of roof coatings. RP3 is far superior to any traditional roof material application, including synthetic underlayments.",
  },
  {
