      ...
      <div className="bg-white text-gray-900 min-h-screen">
        <div className="max-w-3xl mx-auto px-8 py-10 print:py-4 print:px-6">
          ...
          <Section title="II. Prior Rights Timeline">
            <table className="w-full text-sm font-sans border-collapse">
              ...
              <tbody className="text-xs">
                ...
                <tr className="border-b border-gray-200 bg-blue-50"><td className="py-2 pr-4 font-semibold">Jun. 8, 2006</td><td className="py-2 pr-4 font-semibold">USPTO trademark application filed — Serial #78903590. Mark: "Don't Reroof — Weatherproof at 1/2 the Cost / The Original Liquid Applied Rubber Roof Shield System / RoofProtect Seals, Restores and Preserves." Principal Register. IC 002 (roof coatings), IC 037 (roofing installation/repair), IC 040 (waterproofing).</td><td className="py-2 text-blue-800 font-semibold">Federal application in exact goods/services categories now used by theroof.store — filed 15 years before theroof.store was registered</td></tr>
                <tr className="border-b border-gray-200 bg-blue-50"><td className="py-2 pr-4 font-semibold">Jun. 2, 2009</td><td className="py-2 pr-4">USPTO registration granted — Reg. #3633280. Mark fully examined, approved, and placed on Principal Register. Active federal registration status begins.</td><td className="py-2 text-blue-800">Federal registration confirmed — 12 years before theroof.store registered</td></tr>
                <tr className="border-b border-gray-200 bg-blue-50"><td className="py-2 pr-4 font-semibold">Jan. 11, 2016</td><td className="py-2 pr-4">Registration cancelled — Section 8 maintenance declaration not filed (years 5–6 post-registration). This is a maintenance cancellation, NOT abandonment (Lanham Act § 45: abandonment requires non-use + intent to abandon; commercial use continued). Common law rights intact. New federal application in preparation including "The Roof Store" as a named mark.</td><td className="py-2 text-blue-800">6 yrs 7 months of active federal registration; cancellation is administrative only — not a finding of non-use or abandonment</td></tr>
          ...
          <Section title="III. Domain Registration Evidence (Exhibit A)">
            ...
            <p className="text-sm font-sans mt-2"><strong>Exhibit G-2 — 1998–1999 Fort Lauderdale Home Show booth photograph:</strong> Original photo of the company's trade show booth displaying the banner "Anthony's Enterprises, Inc. — All Surface Restorations &amp; Preservations" and the slogan "Don't Reroof — Waterproof! ½ THE COST OF A REROOF," with the founder present. Dated physical-world proof of public commercial use of the exact slogan still in use today, 22+ years before respondent registered theroof.store (Aug 2021). Corroborates the Anthony's Enterprises chain of title independently confirmed by Sunbiz records and 2002–2005 WHOIS.</p>
            <p className="text-sm font-sans mt-2"><strong>Exhibit G-3 — Circa-2000 original "Anthony Enterprises" online store (recovered from hosting server):</strong> The company's original HTML shopping-cart storefront located fully intact on the hosting server (12 .htm pages + 52 graphics in the legacy /store/ directory) on July 30, 2026, and preserved unaltered in the project repository. Homepage displays the "Don't Reroof — Weatherproof at ½ the Cost" banner, a Roofshield™ 5-gallon bucket with the SSS shield logo, and a working cart selling Thermocoat at $129.25; page source contains the year 2000. First-party primary-source proof of e-commerce roofing product sales approximately 21 years before respondent registered theroof.store (Aug 2021), corroborating the Wayback archive record with files under the complainant's continuous custody. The storefront was publicly served on the complainant's own domain at theroofstore.net/store/, independently corroborated by the Wayback Machine's archive of theroofstore.net /store/ URLs — tying the circa-2000 e-commerce operation directly to the same domain in continuous use today.</p>
            <p className="text-sm font-sans mt-2 border border-green-500 bg-green-50 rounded p-3"><strong>Phone continuity — 21 years of unbroken commercial use:</strong> The phone number <strong>(754) 367-3768</strong> first documented in the April 25, 2005 Wayback Machine capture of theroofstore.net remains in active commercial use today (July 2026) on ftlauderdaleroofcoating.com, an authorized network site operating under the same brand system. A phone number documented on theroofstore.net in 2005 and still active in the brand network in 2026 = 21-year chain of continuous commercial use, independently verifiable via Internet Archive and the live website.</p>
            <p className="text-sm font-sans mt-2 border border-amber-400 bg-amber-50 rounded p-3"><strong>Note for counsel — brochure address discrepancy:</strong> The Storm Shield Paint Systems Inc. marketing brochure (Exhibit G in the full evidence file) lists the business address as <strong>4700 Sheridan Street, Suite J, Hollywood, FL 33021</strong>. Current live schema lists <strong>4801 S University Dr, Davie, FL 33328</strong>. This reflects a physical relocation — both addresses are legitimate and correspond to different periods. Recommend adding a date-of-relocation qualifier to any brochure exhibit before filing to prevent opposing counsel from characterizing the discrepancy as inconsistency.</p>
          </Section>
          ...
          <Section title="X. Google Platform Complaint — Evidence &amp; Relief (Exhibits P, Q, R, T)">
            ...
            <div className="border border-gray-300 rounded overflow-hidden mb-2 max-w-xs mx-auto">
              <img
                src="/images/evidence/exhibit-t-ai-answer-phone-capture.jpg"
                alt="Exhibit T-1: device photograph of the live Google AI answer showing the misattributed 'The Roof Store Synthetic Roofing Underlayment' entry"
                className="w-full"
              />
              <p className="text-[10px] font-sans text-gray-500 px-2 py-1 italic border-t border-gray-300">Exhibit T-1 — Device photograph of the live Google AI answer (Aug 2, 2026): genuine "Fungal Shield Crystal Clear" entry followed by the misattributed "The Roof Store Synthetic Roofing Underlayment" entry, as presented to a consumer.</p>
            </div>
            <p className="text-xs font-sans mb-4"><strong>Factual record:</strong> The Roof Store / theroofstore.net has never made, sold, or mentioned any synthetic roofing underlayment; no such product or those certification numbers appear anywhere on theroofstore.net. <strong>Analysis:</strong> consistent with Google's knowledge systems conflating the infringing theroof.store entity's product line with the complainant's brand — the brand confusion documented in Exhibits K, P, Q, R has now propagated into Google's AI answer layer. Significance: (a) direct evidence of consumer-facing brand confusion in Google's newest surface (AI answers); (b) misattribution of a competitor/infringer product to the complainant — a new category of harm (product-line misrepresentation); (c) the same answer directed the leak-repair customer to three competing contractors (Earl W. Johnston Roofing, Istueta Roofing, T&amp;S Roofing Systems) while presenting the conflated profile; (d) despite being asked directly about the complainant's products, the AI's profile never mentioned Roof Shield (RP3) — the flagship system — the world's only system to pass the Dade County Certified TAS-106 Uplift Test — and the very product that answers the consumer's leak question non-intrusively — leaving a consumer to conclude the complainant offers nothing for their leak beyond a traditional under-tile material; (e) the infringing product displaced the complainant's actual solution at the precise point of need — the AI framed the misattributed underlayment as the answer for a leak requiring an intrusive, risky, and expensive "lift and reset" of the tiles, when the complainant's genuine Roof Shield (RP3) system exists specifically to make that procedure unnecessary (a seamless coating installed without lifting a single tile), steering the consumer toward the intrusive path while the complainant received neither the sale nor the attribution. <strong>Complainant's contention as to strategic intent:</strong> the product overlap is not coincidental — the complainant's longstanding tagline "Don't Re-Roof. Weatherproof at 1/2 the Cost." is the direct alternative to tile lift-off/re-roofing, and by adopting the identical name while selling underlayment (the core material of the re-roof procedure the complainant's system makes unnecessary), the respondent both appropriates the brand and re-associates it with the traditional approach the complainant's business displaces; the captured AI answer realizes both harms simultaneously.</p>

            <h4 className="text-xs font-bold uppercase tracking-wide text-gray-700 mb-2">Exhibit U — Respondent's Own Live Product Listing Confirms the Source of the AI Misattribution (Verified Aug 2, 2026)</h4>
            <p className="text-xs font-sans mb-2">On August 2, 2026, the product described in Exhibit T was located for sale on the respondent's own website at https://www.theroof.store/product/the-roof-store-synthetic-roofing-underlayment. The live listing is titled "The Roof Store Synthetic Roofing Underlayment ASTM D8257" and states verbatim: "Florida Approval # 48228. Intertek CCRR 0401. 100 GSM. Passes ASTM D8257. The Roof Store Synthetic Roofing Underlayment is coated, woven polypropylene mechanically attached underlayment." Every identifying detail Google's AI attributed to "The Roof Store" matches this listing word for word — the misattributed product is the respondent's actual product, carrying the complainant's trade name in its title. Timeline (public records): theroofstore.net first archived April 28, 2001 (company use since 1994); theroof.store registered August 13, 2021 (RDAP/Tucows Registry; registrar GoDaddy), first archived December 27, 2021, operating as a store by December 2022 — approximately 27 years after the complainant's first use.</p>
            ...
            <div className="space-y-3 text-xs font-sans">
              ...
              <div className="border border-gray-200 rounded"><div className="bg-gray-100 px-3 py-1 font-bold border-b border-gray-200">What trademark is being infringed</div><div className="px-3 py-2">The trade name and brand "The Roof Store," used continuously in commerce since 1994 in the roofing industry in Florida. Domain theroofstore.net registered and actively used since 2002. Common law trademark rights under prior use in commerce apply, confirmed by trademark counsel. Additionally, the prior rights holder previously held a federal trademark registration (USPTO Reg. #3633280) covering the identical goods and services now offered by theroof.store — elastomeric roof coatings (IC 002), roofing installation and repair (IC 037), and waterproofing treatment of surfaces (IC 040). That registration is lapsed but the underlying commercial use was never abandoned. A new federal application is in preparation and will include "The Roof Store" as a named mark.</div></div>
          ...
          <div className="border-t-2 border-gray-900 pt-5 mt-8 flex justify-between text-xs font-sans text-gray-500">
            ...
            <div className="text-right">
              <p>Document prepared: July 30, 2026</p>
