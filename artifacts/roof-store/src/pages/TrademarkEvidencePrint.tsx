          ...
          <Section title="II. Prior Rights Timeline">
            <table className="w-full text-sm font-sans border-collapse">
              ...
              <tbody className="text-xs">
                ...
                <tr className="border-b border-gray-200 bg-blue-50 font-semibold"><td className="py-2 pr-4">~2006–2009</td><td className="py-2 pr-4">Federal trademark registration obtained — USPTO Reg. #3633280, Serial #78903590. Mark: "Don't Reroof — Weatherproof at 1/2 the Cost / RoofProtect Seals, Restores and Preserves." Classes: IC 002 (roof coatings), IC 037 (roofing installation/repair), IC 040 (waterproofing). Registration later lapsed; common law rights intact and confirmed by trademark attorney. New application in preparation including "The Roof Store" as a named mark.</td><td className="py-2 text-blue-800">Federal government confirmation of commercial use in exact goods/services categories now used by theroof.store — 12+ years before theroof.store was registered</td></tr>
