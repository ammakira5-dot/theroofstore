...
export const fungalShield: ProductData = {
  ...
  seoTitle: "Fungal Shield (RP1) — Clear Roof Tile Sealer & Anti-Fungal Roof Coating | The Roof Store Florida",
...
export const smartShield: ProductData = {
  ...
  seoTitle: "Smart Shield (RP2) — Reflective Cool Roof Coating for Tile | The Roof Store Florida",
...
export const roofShield: ProductData = {
  ...
  seoTitle: "Roof Shield (RP3) — The Original Liquid Applied Rubber Roof Shield System | The Roof Store Florida",
