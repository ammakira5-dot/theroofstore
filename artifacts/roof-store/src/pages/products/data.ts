...
export const roofShield: ProductData = {
  ...
  features: [
    ...
    { title: "135+ MPH Documented Wind Resistance — 5× Stronger", desc: "Not simulated — real documented hurricane projects where treated roofs did not lose a single tile. 5× the wind uplift resistance of a new tile roof at 60–70% less cost." },
