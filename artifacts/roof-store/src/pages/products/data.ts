...
export const fungalShield: ProductData = {
  ...
  seoTitle: "Fungal Shield (RP1) — Anti-Fungal Roof Coating | The Roof Store Florida",
  seoDescription: "Fungal Shield (RP1) eliminates black streaking, algae, mold, and fungal growth on Florida roofs. Clear elastomeric base with active biocide formula. Mildew resistant. 5-Year Product Warranty. Free quote — 954-210-9614.",
...
export const smartShield: ProductData = {
  ...
  seoDescription: "Smart Shield is a reflective, elastomeric cool roof coating that waterproofs tile roofs in 3,000+ colors. BASF Cool Pigment means the darker the color, the more it reflects. Can be fortified with polyurethane or ceramic for non-reflective applications. FP&L confirmed energy savings. Free quote — 954-210-9614.",
  heroDesc: "A full waterproof, weatherproof elastomeric coating system for tile roofs — in over 3,000 tintable colors. As a reflective cool roof coating, the darker the color, the more it reflects. FP&L confirmed energy savings. Exclusively available through The Roof Store.",
  heroImage: `${BASE}/images/Waterproofing-Technology.jpg`,
  overview: [
    "Smart Shield (RP2) is Roof Protect's most popular system, available exclusively through The Roof Store — a complete waterproof and weatherproof elastomeric roof coating engineered specifically for Florida tile roofs. Its base formula is elastomeric, tuned for darker tile colors, and it seals the tile surface against wind-driven rain, UV degradation, moisture intrusion, and mildew growth. It is 5× thicker than standard roof paint and bonds directly to the tile, forming a durable rubber-acrylic barrier that extends tile life significantly.",
    "Smart Shield's formula can also be fortified with polyurethane or ceramic for certain tile roofs where a non-reflective finish is preferred, and for some flat roof applications — the right fortification depends on the roof deck's drainage and the project's price point. It is important to understand what Smart Shield is and is not. For the main field tiles, Smart Shield is a surface coating — it protects the tile face and waterproofs the roof without filling the spaces between individual tiles. That full gap-filling monolithic treatment is the job of our Roof Shield (RP3) system. Where Smart Shield does add structural reinforcement is at the ridge caps: during every installation, the ridge caps are polyurethaned and fiber coated as a minimum standard. Ridge caps are the most wind-vulnerable section of any tile roof in South Florida, and this treatment gives them meaningful additional hurricane wind-lift protection — even on a Smart Shield-only job.",
  ...
  features: [
    ...
    { title: "Polyurethane or Ceramic Fortification Available", desc: "For tile roofs that don't want a reflective finish, or for certain flat roof applications, Smart Shield's base can be fortified with polyurethane or ceramic — the right option depends on price point and roof deck drainage." },
  ...
  specs: [
    ...
    { label: "Base Formula", value: "Elastomeric — fortifiable with polyurethane or ceramic for non-reflective or flat roof applications" },
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Yes — Smart Shield's elastomeric base can be fortified with polyurethane or ceramic for tile roofs where a non-reflective finish is preferred, or for certain flat roof applications. Which fortification makes sense depends on your price point and the roof deck's drainage. We'll recommend the right formulation during your free evaluation.",
    },
    {
  ...
  beforeAfterImages: [
    {
      ...
      beforeAlt: "Cement tile roof before Roof Shield — visible gaps and voids between tiles",
      after: "https://www.theroofstore.net/assets/images/imageafter.png",
      afterAlt: "Cement tile roof after Roof Shield — all gaps sealed, monolithic surface",
    },
    {
      label: "Barrel Tile Roof",
      before: "https://www.theroofstore.net/assets/images/1.jpg",
      beforeAlt: "Barrel tile roof before Roof Shield — open spaces between tile ribs",
      after: "https://www.theroofstore.net/assets/images/2-min.jpeg",
      afterAlt: "Barrel tile roof after Roof Shield — every space between tiles sealed solid",
    },
  ],
};
