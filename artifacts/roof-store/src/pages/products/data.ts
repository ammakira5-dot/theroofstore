...
export const roofShield: ProductData = {
  ...
  features: [
    ...
    { title: "World's Only TAS-106 Rated Coating", desc: "The only Dade County TAS-106 Uplift Pull Test Resistance Rated roof coating system worldwide — the same standard required for new tile installations. Originally certified 2006." },
