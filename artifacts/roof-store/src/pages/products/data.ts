...
export const smartShield: ProductData = {
  ...
  galleryImages: [
    {
      src: `${BASE}/images/projects/clay-tile-before.png`,
      alt: "Clay tile roof before Smart Shield application",
      caption: "Clay tile — before Smart Shield",
    },
    {
      src: `${BASE}/images/projects/clay-tile-after.png`,
      alt: "Clay tile roof after Smart Shield application",
      caption: "Clay tile — after Smart Shield",
    },
    {
      src: `${BASE}/images/projects/flat-cement-before.png`,
      alt: "Flat cement roof before Smart Shield waterproofing",
      caption: "Flat cement — before Smart Shield",
    },
    {
      src: `${BASE}/images/projects/flat-cement-after.png`,
      alt: "Flat cement roof after Smart Shield waterproofing",
      caption: "Flat cement — after Smart Shield",
    },
    {
      src: `${BASE}/images/projects/spanish-tile-before.png`,
      alt: "Spanish tile roof before Smart Shield application",
      caption: "Spanish tile — before Smart Shield",
    },
    {
      src: `${BASE}/images/projects/spanish-tile-after.png`,
      alt: "Spanish tile roof after Smart Shield application",
      caption: "Spanish tile — after Smart Shield",
    },
    {
      src: `${BASE}/images/projects/flat-deck-before-2.png`,
      alt: "Flat deck roof before Smart Shield waterproofing",
      caption: "Flat deck — before Smart Shield",
    },
    {
      src: `${BASE}/images/projects/flat-deck-after-2.png`,
      alt: "Flat deck roof after Smart Shield waterproofing",
      caption: "Flat deck — after Smart Shield",
    },
  ],
};
...
export const roofShield: ProductData = {
  ...
  overview: [
    ...
    "Roof Shield is the professional descendant of the tile-securing technique roof painters discovered decades ago — refined, warrantied, and engineered specifically to fill every gap between tiles rather than just coat the surface.",
  ],
  features: [
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Roof Shield is typically approximately half the cost of a full tile roof replacement — while delivering 5× the wind uplift resistance and a monolithic structure no new roof can match. Most residential projects save $20,000–$80,000. Call us for a free evaluation.",
    },
  ],
  relatedProducts: [
    { name: "Fungal Shield", href: "/products/fungalshield", desc: "Anti-fungal & anti-algae coating — eliminate black streaking.", icon: Leaf },
