...
export const fungalShield: ProductData = {
  ...
  seoDescription: "Fungal Shield (RP1) is a clear roof tile sealer that eliminates black streaking, algae, mold, and fungal growth on Florida tile, metal, and flat roofs. Also works as a protective clear metal roof coating. Mildew resistant. 5-Year Product Warranty. $190 — Free quote 954-210-9614.",
...
export const smartShield: ProductData = {
  ...
  seoDescription: "Smart Shield is a reflective cool roof coating that waterproofs tile roofs in 3,000+ colors. BASF Cool Pigment means the darker the color, the more it reflects. Base can be elastomeric or polyurethane, or blended with ceramic for a flatter, less-reflective look. FP&L confirmed energy savings. Free quote — 954-210-9614.",
...
export const roofShield: ProductData = {
  ...
  seoDescription: "Roof Shield — The Original Liquid Applied Rubber Roof Shield System — fills every gap and void between your tiles with multiple product layers — making your roof monolithic. Typically formulated with a silicone base for all roof types, including flat roofs that hold water. TAS-106 rated, 5× stronger, lifetime warranty. 954-210-9614.",
