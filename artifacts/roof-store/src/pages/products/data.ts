...
export const roofShield: ProductData = {
  ...
  learnMoreLinks: [
    { title: "The TAS-106 Uplift Test", desc: "What the Dade County Certified test is, and how Roof Shield passed it.", href: "/tas-106-certified-roof-coating" },
    { title: "The 35-Pound Pull Test Explained", desc: "What 'passing' means in real numbers — and our 100-lbf no-movement result.", href: "/tas-106-certified-roof-coating#35-pound-pull-test" },
    { title: "What 'Monolithic' Really Means", desc: "How filling every tile gap turns hundreds of loose tiles into one continuous shell.", href: "/tas-106-certified-roof-coating#monolithic" },
    { title: "5× Stronger Than a New Tile Roof", desc: "The uplift-strength comparison behind the 5× claim.", href: "/tas-106-certified-roof-coating#five-times-stronger" },
    { title: "Insurance & Your Roof's Useful Life", desc: "How a coated, well-maintained roof holds up at insurance inspection time.", href: "/tas-106-certified-roof-coating#insurance" },
    { title: "Roof Painting vs. Roof Coating", desc: "Where roof painting came from — and how it evolved into this system.", href: "/roof-painting-vs-coating" },
    { title: "Silicone vs. Elastomeric Coatings", desc: "Why the silicone base matters, especially for flat roofs that hold water.", href: "/silicone-vs-elastomeric-roof-coating" },
    { title: "The Manufacturer's Inspection Report", desc: "The full onsite inspection every Roof Shield project starts with.", href: "/manufacturers-report" },
    { title: "The Alternative to Roof Replacement", desc: "How Roof Shield compares to a tear-off — at roughly half the cost.", href: "/roof-replacement-alternative-florida" },
    { title: "Hurricane Prep for Your Roof", desc: "Getting a Florida roof storm-ready before the season hits.", href: "/hurricane-roof-prep" },
  ],
