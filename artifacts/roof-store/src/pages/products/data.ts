...
export const smartShield: ProductData = {
  ...
  seoTitle: "SmartShield (RP2) — Reflective Cool Roof Coating for Tile | The Roof Store Florida",
  seoDescription: "SmartShield is a reflective, elastomeric-acrylic cool roof coating that waterproofs tile roofs in 3,000+ colors. BASF Cool Pigment means the darker the color, the more it reflects. FP&L confirmed energy savings. Exclusive — not in any retail store. Free quote — 954-210-9614.",
  ...
  overview: [
    ...
    "What sets SmartShield apart from any other waterproof tile coating is its color capability. Over 3,000 tintable color options — and in collaboration with BASF, the world's largest chemical producer, we engineered a breakthrough no other reflective roof coating has achieved: Cool Pigment Technology that increases Total Solar Reflectance (TSR) by 32%, even at the darkest black. The counterintuitive result: the darker the color you choose, the more heat this cool roof coating reflects. Florida Power & Light (FP&L) independently confirmed the energy savings. Manufactured exclusively at our Davie, Florida facility — not available in any retail store.",
  ],
  features: [
