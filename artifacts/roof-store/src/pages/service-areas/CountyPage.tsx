  ...
  return (
    <div className="w-full">
      <SEO
        ...
        description={`Looking for a roof painting contractor in ${county}? The Roof Store provides professional roof coating systems for tile, flat, shingle, and metal roofs that outperform standard paint — waterproof, hurricane-rated, licensed & insured, A+ BBB since 1994. Free inspection: 954-210-9614.`}
