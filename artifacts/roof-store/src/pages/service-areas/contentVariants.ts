...
export const serviceVariants: ((city: string) => { title: string; desc: string }[])[] = [
  (city) => [
    ...
    { title: "Tile Roof Waterproofing", desc: `Our Smart Shield system seals individual tiles with a durable, flexible waterproof coating — stopping leaks without a full replacement. Covers Spanish tile, flat cement tile, and clay barrel tile roofs in ${city}. For roofs needing every gap between tiles fully sealed into one monolithic surface, our Roof Shield system adds that extra layer.` },
  ...
  (city) => [
    ...
    { title: "Tile Waterproofing", desc: `Smart Shield coats and seals individual tiles with a flexible waterproof membrane, stopping leaks for good — no full tear-off required — suitable for Spanish tile, flat cement tile, and clay barrel tile found around ${city}. Roofs that also need every gap between tiles filled can step up to our monolithic Roof Shield system.` },
  ...
  (city) => [
    ...
    { title: "Tile Roof Sealing", desc: `Smart Shield seals individual tiles with a flexible, leak-stopping coating over Spanish tile, flat cement tile, and clay barrel tile throughout ${city} — no replacement necessary. For a fully monolithic, gap-filled roof, our Roof Shield system takes it a step further.` },
  ...
  (city) => [
    ...
    { title: "Tile Leak Sealing", desc: `Our Smart Shield system seals individual Spanish tile, flat cement tile, and barrel tile roofs across ${city} with a flexible waterproof coating — stopping leaks without a tear-off. Roofs needing every tile gap fully sealed can upgrade to our monolithic Roof Shield system.` },
