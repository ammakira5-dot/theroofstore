...
export const serviceVariants: ((city: string) => { title: string; desc: string }[])[] = [
  (city) => [
    ...
    { title: "Hurricane Protection Coating", desc: `Our Roof Shield system is the world's only TAS-106 Dade County Uplift rated coating — engineered to withstand South Florida hurricane-force winds and keep ${city} homes protected season after season. Want maximum reflectivity on a dark color? Smart Shield can be applied as a top coat over Roof Shield.` },
  ...
  (city) => [
    ...
    { title: "Hurricane-Rated Coating", desc: `Roof Shield carries the world's only TAS-106 Dade County Uplift rating — built to keep ${city} roofs intact through hurricane season year after year. For maximum reflectivity on a dark color choice, Smart Shield can be layered on top as a cooling top coat.` },
  ...
  (city) => [
    ...
    { title: "Wind & Hurricane Coating", desc: `Roof Shield holds the only TAS-106 Dade County Uplift certification of any liquid coating, giving ${city} roofs proven hurricane protection. Want maximum reflectivity on a dark color? Add Smart Shield as a top coat over Roof Shield for extra cooling.` },
