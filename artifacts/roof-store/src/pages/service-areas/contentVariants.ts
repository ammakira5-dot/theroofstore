...
export const serviceVariants: ((city: string) => { title: string; desc: string }[])[] = [
  (city) => [
    ...
    { title: "Tile Roof Waterproofing", desc: `Seal every tile surface with a continuous waterproof membrane that stops leaks permanently — without the cost of a full replacement. Covers Spanish tile, flat cement tile, and clay barrel tile roofs in ${city}.` },
  ...
  (city) => [
    ...
    { title: "Tile Waterproofing", desc: `A continuous membrane across every tile stops leaks for good, no full tear-off required — suitable for Spanish tile, flat cement tile, and clay barrel tile found around ${city}.` },
  ...
  (city) => [
    ...
    { title: "Tile Roof Sealing", desc: `A continuous, leak-stopping membrane goes over Spanish tile, flat cement tile, and clay barrel tile throughout ${city} — no replacement necessary.` },
  ...
  (city) => [
    ...
    { title: "Tile Leak Sealing", desc: `We seal Spanish tile, flat cement tile, and barrel tile roofs across ${city} with a single continuous waterproof membrane — stopping leaks without a tear-off.` },
