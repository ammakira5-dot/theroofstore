...
export const counties: CountyEntry[] = [
  {
    ...
    cities: [
      ...
      },
      {
        ...
        blurb:
          "Our home base — The Roof Store has operated out of Davie since 1994, and we know the local roofing landscape better than anyone. Davie's unique mix of equestrian estates, suburban neighborhoods, and commercial properties means we work on everything from large flat-deck barn roofs to Spanish tile on residential homes throughout the town.",
      },
      {
