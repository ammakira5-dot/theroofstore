...
- **Factory page conversion-flow optimization — DONE July 30 (option A, approved)** — "What brings you here?" fork moved directly under the hero (stats bar now below it); "Need it installed?" card highlighted with accent border + "Most Popular" badge; "Get a Free Estimate" is now the lead button in that card. No copy/photos changed. **Needs next publish to go live.**
