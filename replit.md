...
- **Factory page conversion-flow optimization — TRIED + REVERTED July 30** — Option A (fork moved up, estimate card highlighted) was built, owner saw it and asked to put it back exactly as it was. Fully reverted; page matches pre-change layout. Do not re-propose reordering — owner likes the current look.
