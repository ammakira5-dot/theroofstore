...
- **Gallatin TN "The Roof Store" (goroofstoretn.com) — document in Monitoring Log (agent-ready, say go ahead)** — Third party operating as "The Roof Store" in Gallatin TN since 2019 (Jeff Christian, 660 Cole's Ferry Rd, (615) 989-7889); GMB listing under exact name; logo = "The Roof Store" embedded in house graphic. Homepage screenshot captured July 30 2026: `attached_assets/screenshots/goroofstoretn_com.png`. Pending: (1) owner screenshot of their Google Business Profile showing the name (search "The Roof Store Gallatin TN" on Maps, Windows+PrtScn); (2) approval to add dated Monitoring & Defense Log entry + optional "Third-Party Same-Name Entities" note for counsel. Caveat for counsel: distant local contractor — cuts both ways in UDRP (dilution vs. genericness argument).
- **Houston "The Roof Store" = Dmitry/theroof.store (confirmed July 30 2026) — document as exact-name commercial use (agent-ready, say go ahead)** — NOT a third party. theroof.store operates physically in Houston as "The Roof Store": 3522 Yale St, Houston TX 77018 (office) + 1401 Greengrass Dr Dock 14, 77008 (warehouse/pickup), 713-480-1168. Exact-name listings found: Google Business Profile, Yelp (yelp.com/biz/the-roof-store-houston-2, categorized "Hardware Stores"), Yellow Pages, IndustryNet wholesale directory, LinkedIn company page "The Roof Store". Strengthens confusion case: active retail branding under the exact mark, not just the domain. On approval: add dated Monitoring Log entry; owner screenshots of the GMB/Yelp/YP listings (URL bar visible) would make it exhibit-grade.
...
- **Owner's 301 CSV refinements — DONE July 30 (needs publish)** — per owner's redirect-map CSV (attached_assets/theroofstore-301-redirect-map_1785379683660.csv): added `/calcium-carbonate.php`→/products, `/by-the-yard.php`→/shop, `/Brochure_2008_pdf.pdf` + `/Brochure_2011xs.pdf`→/products; repointed `/50rubber.html` /products→/factory (100% Pure Liquid Rubber section) and contracting license page /factory→/about (Credentials block; manufacturing license stays /factory — agreed split). `/123.html` left as homepage 301 (owner OK). All curl-verified + regression spot-check clean. server.js only — no rebuild needed. NEXT: owner's GA4 Measurement ID still needed for analytics install; content-mining of licensing + calcium-carbonate historical copy is the agreed follow-up (recovery plan at attached_assets/legacy-content-recovery-plan_1785379374030.html).
- **Exhibit G-3 — circa-2000 original online store — DONE July 30 (needs publish)** — Original "Anthony Enterprises" HTML store found fully intact on the hosting server in `/store/` (12 .htm pages + 52 graphics, 64 files); snapshot preserved at `docs/old-site-backups/store-htm-site-snapshot-2026-07-30/`. Homepage shows "Don't Reroof — Weatherproof at ½ the Cost" banner, Roofshield™ SSS-shield bucket, working cart selling Thermocoat at $129.25; source contains year 2000. Added as **Exhibit G-3** in TrademarkEvidenceFile.tsx (section IX-C + timeline row + monitoring-log entry), summarized in TrademarkEvidencePrint.tsx, and year-2000 milestone added to /about. Exhibit image: `/images/anthony-enterprises-online-store-circa-2000.jpg`. Evidence document dates updated July 22 → July 30 on both evidence pages. Domain-provenance sentence added to G-3 on both pages (served at theroofstore.net/store/, Wayback-corroborated). Build + prerender 160/160 verified.
- **Wayback legacy URL restoration + shingle/metal pages — DONE July 30 (needs publish)** — (1) All 126 ancient .htm/.html/.swf/store-era URLs (found via Wayback archive, list at `docs/wayback-results-2026-07-30.txt`) now 301 to their closest modern equivalents in server.js, plus a `/store/` → /shop catch-all and a .htm/.html/.swf → / catch-all so no archived URL can ever 404. (2) Two new SEO pages built on the tile-service template: **/shingle-roof-coating** (SmartShield system) and **/metal-roof-coating** (commercial metal, SmartShield + RoofShield) with own FAQs/process/FAQ schema; ~13 legacy shingle/metal/cement .php + bare-slug 301s repointed to them; linked from /roof-services cards; sitemap now 160 URLs; full build + prerender 160/160 verified; 0 regressions across the 209 pre-existing redirects (all curl-verified locally). After publish: GSC Request Indexing for the 2 new URLs + resubmit sitemap.xml.
- **Spanish/S-Tile keyword URL restoration — DONE July 29 (needs publish)** — 5 new tile service pages (/spanish-tile-roof-coating, /spanish-tile-roof-painting, /spanish-tile-roof-waterproofing, /spanish-tile-roof-maintenance, /cement-tile-roof-restoration) with FAQ schema + internal links from /roof-services cards; ~50 legacy 301s repointed/added in server.js incl. 44 previously-unmapped /fl/ city URLs, plus 6 more old-site URLs (4 /services/ + 2 /projects/) found live on theroofstore.absolutecharters.com and their bare-slug variants; client redirects in App.tsx aligned; sitemap now 158 URLs; full build + prerender (158/158) verified locally. Full old→new URL map: `docs/spanish-tile-url-restoration.md`. After publish: GSC Request Indexing for the 5 new URLs + resubmit sitemap.xml.
