...
- **Add BBB/Facebook/Yelp URLs to sameAs schema** — `Home.tsx` BUSINESS_CORE.sameAs has only 2 Google Maps links. Facebook: https://www.facebook.com/profile.php?id=100068045314754 — BBB: https://www.bbb.org/us/fl/hollywood/profile/painting-contractors/storm-shield-paint-systems-inc-0633-90131779 (BBB shows "est. 2002" but actual founding is 1994/1995 — use correct year in schema). Still need Yelp URL, then agent adds all at once.
