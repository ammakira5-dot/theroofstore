...
export const staticRoutes: UrlEntry[] = [
  ...
  { loc: "/spanish-tile-roof-coating", changefreq: "monthly", priority: "0.8" },
  { loc: "/spanish-tile-roof-painting", changefreq: "monthly", priority: "0.8" },
  { loc: "/spanish-tile-roof-waterproofing", changefreq: "monthly", priority: "0.8" },
  { loc: "/spanish-tile-roof-maintenance", changefreq: "monthly", priority: "0.8" },
  { loc: "/cement-tile-roof-restoration", changefreq: "monthly", priority: "0.8" },
  { loc: "/shingle-roof-coating", changefreq: "monthly", priority: "0.8" },
  { loc: "/metal-roof-coating", changefreq: "monthly", priority: "0.8" },
